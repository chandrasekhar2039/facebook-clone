...
function Navbar_comp() {
  ...
  return <>
   ...
   <Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="navbar_main">
     ...
     <Nav.Link href="#2"  data-title="Watch"> <div className="icon"><Badge color="secondary" badgeContent={99} max={9}  ><OndemandVideoRoundedIcon /></Badge><h6>Home</h6></div></Nav.Link>
     <Nav.Link href="#3" data-title="Gamming"> <div className="icon" ><Badge color="secondary" badgeContent={4} max={9} ><NfcRoundedIcon /> </Badge><h6>Home</h6></div></Nav.Link>
     <Nav.Link href="#4" data-title="Marketplace">  <div className="icon" ><Badge color="secondary"><StorefrontRoundedIcon /></Badge><h6>Home</h6></div></Nav.Link>
     <Nav.Link href="#5" data-title="Groups"><div className="icon" ><Badge color="secondary"> <GroupRoundedIcon /></Badge><h6>Home</h6></div></Nav.Link>
     </Nav>
